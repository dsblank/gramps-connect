...
# 1. Enter a Name -- this is the tab label -- like "Details"
# 2. Enter a Description, like "A summary of the selected person: IDs, gender, alternate names, parents and family"
