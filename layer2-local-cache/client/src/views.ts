...
// here; browser.ts's fetch/cache/scroll/render engine is generic over
// whichever one is active, it doesn't know "person" or "family" by name.
...
export const PERSON_VIEW: ViewConfig = {
  ...
  opfsFilename: "layer2-cache-person.sqlite",
...
export const FAMILY_VIEW: ViewConfig = {
  ...
  opfsFilename: "layer2-cache-family.sqlite",
...
export const EVENT_VIEW: ViewConfig = {
  ...
  orderBy: [{ column: "gramps_id", direction: "asc" }],
  opfsFilename: "layer2-cache-event.sqlite",
...
export const PLACE_VIEW: ViewConfig = {
  ...
  opfsFilename: "layer2-cache-place.sqlite",
...
export const REPOSITORY_VIEW: ViewConfig = {
  ...
  opfsFilename: "layer2-cache-repository.sqlite",
...
export const SOURCE_VIEW: ViewConfig = {
  ...
  orderBy: [{ column: "title", direction: "asc" }],
  opfsFilename: "layer2-cache-source.sqlite",
...
export const CITATION_VIEW: ViewConfig = {
  ...
  orderBy: [{ column: "gramps_id", direction: "asc" }],
  opfsFilename: "layer2-cache-citation.sqlite",
...
export const MEDIA_VIEW: ViewConfig = {
  ...
  opfsFilename: "layer2-cache-media.sqlite",
...
export const NOTE_VIEW: ViewConfig = {
  ...
  orderBy: [{ column: "gramps_id", direction: "asc" }],
  opfsFilename: "layer2-cache-note.sqlite",
...
export const TAG_VIEW: ViewConfig = {
  ...
  orderBy: [{ column: "name", direction: "asc" }],
  opfsFilename: "layer2-cache-tag.sqlite",
